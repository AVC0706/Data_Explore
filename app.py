...
def main():
    ...
    html_temp = """
	<div style="background-color:tomato;"><p style="color:white;font-size:50px;padding:10px">EXPLORE DATA</p></div>
	"""
    ...
    if st.checkbox("Show Dataset"):
                # st.catplot(x="State/UT", y="TotalPublicHealthFacilities_HMIS", data=df)
    ...
    st.sidebar.info("A Data App for Exploring Dataset")
